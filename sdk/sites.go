...
type ResponseSitesGetSiteHealthResponseDnacInfo struct {
	UUID   string `json:"uuid,omitempty"`   // UUID of the CATALYST
	IP     string `json:"ip,omitempty"`     // IP address of the CATALYST
	Status string `json:"status,omitempty"` // Status of the CATALYST
}
