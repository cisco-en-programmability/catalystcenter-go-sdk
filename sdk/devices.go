...
type GetsInterfacesAlongWithStatisticsDataFromAllNetworkDevicesV1QueryParams struct {
...
type GetTheInterfaceDataForTheGivenInterfaceIDinstanceUUIDAlongWithTheStatisticsDataV1QueryParams struct {
	StartTime float64 `url:"startTime,omitempty"` //Start time from which API queries the data set related to the resource. It must be specified in UNIX epochtime in milliseconds. Value is inclusive. If `startTime` is not provided, API will default to current time.
	EndTime   float64 `url:"endTime,omitempty"`   //End time to which API queries the data set related to the resource. It must be specified in UNIX epochtime in milliseconds. Value is inclusive.
...
type ResponseDevicesGetsInterfacesAlongWithStatisticsDataFromAllNetworkDevicesV1 struct {
	Response *[]ResponseDevicesGetsInterfacesAlongWithStatisticsDataFromAllNetworkDevicesV1Response `json:"response,omitempty"` //
	Page     *ResponseDevicesGetsInterfacesAlongWithStatisticsDataFromAllNetworkDevicesV1Page       `json:"page,omitempty"`     //
	Version  string                                                                                 `json:"version,omitempty"`  // Version
}
type ResponseDevicesGetsInterfacesAlongWithStatisticsDataFromAllNetworkDevicesV1Response struct {
	ID                      string   `json:"id,omitempty"`                      // Id
...
type ResponseDevicesGetsInterfacesAlongWithStatisticsDataFromAllNetworkDevicesV1Page struct {
	Limit  *int                                                                                     `json:"limit,omitempty"`  // Limit
	Offset *int                                                                                     `json:"offset,omitempty"` // Offset
	Count  *int                                                                                     `json:"count,omitempty"`  // Count
	SortBy *[]ResponseDevicesGetsInterfacesAlongWithStatisticsDataFromAllNetworkDevicesV1PageSortBy `json:"sortBy,omitempty"` //
}
type ResponseDevicesGetsInterfacesAlongWithStatisticsDataFromAllNetworkDevicesV1PageSortBy struct {
	Name  string `json:"name,omitempty"`  // Name
	Order string `json:"order,omitempty"` // Order
}
...
type ResponseDevicesGetTheInterfaceDataForTheGivenInterfaceIDinstanceUUIDAlongWithTheStatisticsDataV1 struct {
	Response *ResponseDevicesGetTheInterfaceDataForTheGivenInterfaceIDinstanceUUIDAlongWithTheStatisticsDataV1Response `json:"response,omitempty"` //
	Version  string                                                                                                    `json:"version,omitempty"`  // Version
}
type ResponseDevicesGetTheInterfaceDataForTheGivenInterfaceIDinstanceUUIDAlongWithTheStatisticsDataV1Response struct {
	ID                      string   `json:"id,omitempty"`                      // Id
	AdminStatus             string   `json:"adminStatus,omitempty"`             // Admin Status
	Description             string   `json:"description,omitempty"`             // Description
	DuplexConfig            string   `json:"duplexConfig,omitempty"`            // Duplex Config
...
type ResponseDevicesGetDeviceValuesThatMatchFullyOrPartiallyAnAttributeV1 interface{}
...
type RequestDevicesGetsTheTotalNumberNetworkDevicesBasedOnTheProvidedComplexFiltersAndAggregationFunctionsV1Page struct {
	Limit  *int                                                                                                                 `json:"limit,omitempty"`  // Limit
	Offset *int                                                                                                                 `json:"offset,omitempty"` // Offset
	SortBy *[]RequestDevicesGetsTheTotalNumberNetworkDevicesBasedOnTheProvidedComplexFiltersAndAggregationFunctionsV1PageSortBy `json:"sortBy,omitempty"` //
}
...
//GetsInterfacesAlongWithStatisticsDataFromAllNetworkDevicesV1 Gets interfaces along with statistics data from all network devices. - 9898-9b5a-445b-884f
...
@param GetsInterfacesAlongWithStatisticsDataFromAllNetworkDevicesV1QueryParams Filtering parameter
...
*/
func (s *DevicesService) GetsInterfacesAlongWithStatisticsDataFromAllNetworkDevicesV1(GetsInterfacesAlongWithStatisticsDataFromAllNetworkDevicesV1QueryParams *GetsInterfacesAlongWithStatisticsDataFromAllNetworkDevicesV1QueryParams) (*ResponseDevicesGetsInterfacesAlongWithStatisticsDataFromAllNetworkDevicesV1, *resty.Response, error) {
	path := "/dna/data/api/v1/interfaces"

	queryString, _ := query.Values(GetsInterfacesAlongWithStatisticsDataFromAllNetworkDevicesV1QueryParams)

	response, err := s.client.R().
		SetHeader("Content-Type", "application/json").
		SetHeader("Accept", "application/json").
		SetQueryString(queryString.Encode()).SetResult(&ResponseDevicesGetsInterfacesAlongWithStatisticsDataFromAllNetworkDevicesV1{}).
		SetError(&Error).
		Get(path)
	...
	if response.IsError() {
		...
		return nil, response, fmt.Errorf("error with operation GetsInterfacesAlongWithStatisticsDataFromAllNetworkDevicesV1")
	}

	result := response.Result().(*ResponseDevicesGetsInterfacesAlongWithStatisticsDataFromAllNetworkDevicesV1)
	return result, response, err
...
//GetTheInterfaceDataForTheGivenInterfaceIDinstanceUUIDAlongWithTheStatisticsDataV1 Get the interface data for the given interface id (instance Uuid) along with the statistics data - c08d-d95c-4c7b-8283
...
@param GetTheInterfaceDataForTheGivenInterfaceIdinstanceUuidAlongWithTheStatisticsDataV1QueryParams Filtering parameter
...
*/
func (s *DevicesService) GetTheInterfaceDataForTheGivenInterfaceIDinstanceUUIDAlongWithTheStatisticsDataV1(id string, GetTheInterfaceDataForTheGivenInterfaceIdinstanceUuidAlongWithTheStatisticsDataV1QueryParams *GetTheInterfaceDataForTheGivenInterfaceIDinstanceUUIDAlongWithTheStatisticsDataV1QueryParams) (*ResponseDevicesGetTheInterfaceDataForTheGivenInterfaceIDinstanceUUIDAlongWithTheStatisticsDataV1, *resty.Response, error) {
	path := "/dna/data/api/v1/interfaces/{id}"
	path = strings.Replace(path, "{id}", fmt.Sprintf("%v", id), -1)

	queryString, _ := query.Values(GetTheInterfaceDataForTheGivenInterfaceIdinstanceUuidAlongWithTheStatisticsDataV1QueryParams)

	response, err := s.client.R().
		SetHeader("Content-Type", "application/json").
		SetHeader("Accept", "application/json").
		SetQueryString(queryString.Encode()).SetResult(&ResponseDevicesGetTheInterfaceDataForTheGivenInterfaceIDinstanceUUIDAlongWithTheStatisticsDataV1{}).
		SetError(&Error).
		Get(path)
	...
	if response.IsError() {
		if response.StatusCode() == http.StatusUnauthorized {
			return s.GetTheInterfaceDataForTheGivenInterfaceIDinstanceUUIDAlongWithTheStatisticsDataV1(id, GetTheInterfaceDataForTheGivenInterfaceIdinstanceUuidAlongWithTheStatisticsDataV1QueryParams)
		}
		return nil, response, fmt.Errorf("error with operation GetTheInterfaceDataForTheGivenInterfaceIdinstanceUuidAlongWithTheStatisticsDataV1")
	}

	result := response.Result().(*ResponseDevicesGetTheInterfaceDataForTheGivenInterfaceIDinstanceUUIDAlongWithTheStatisticsDataV1)
	return result, response, err
...
func (s *DevicesService) DeletePlannedAccessPointForFloorV1(floorID string, plannedAccessPointUUID string) (*ResponseDevicesDeletePlannedAccessPointForFloorV1, *resty.Response, error) {
	...
	if response.IsError() {
		if response.StatusCode() == http.StatusUnauthorized {
			return s.DeletePlannedAccessPointForFloorV1(
...
func (s *DevicesService) DeleteUserDefinedFieldV1(id string) (*ResponseDevicesDeleteUserDefinedFieldV1, *resty.Response, error) {
	...
	if response.IsError() {
		if response.StatusCode() == http.StatusUnauthorized {
			return s.DeleteUserDefinedFieldV1(
				id)
		}
...
func (s *DevicesService) RemoveUserDefinedFieldFromDeviceV1(deviceID string, RemoveUserDefinedFieldFromDeviceV1QueryParams *RemoveUserDefinedFieldFromDeviceV1QueryParams) (*ResponseDevicesRemoveUserDefinedFieldFromDeviceV1, *resty.Response, error) {
	...
	if response.IsError() {
		if response.StatusCode() == http.StatusUnauthorized {
			return s.RemoveUserDefinedFieldFromDeviceV1(
				deviceID, RemoveUserDefinedFieldFromDeviceV1QueryParams)
		}
...
func (s *DevicesService) DeleteDeviceByIDV1(id string, DeleteDeviceByIdV1QueryParams *DeleteDeviceByIDV1QueryParams) (*ResponseDevicesDeleteDeviceByIDV1, *resty.Response, error) {
	...
	if response.IsError() {
		if response.StatusCode() == http.StatusUnauthorized {
			return s.DeleteDeviceByIDV1(
				id, DeleteDeviceByIdV1QueryParams)
		}
...
func (s *DevicesService) RemoveAllowedMacAddressV1(macAddress string) (*ResponseDevicesRemoveAllowedMacAddressV1, *resty.Response, error) {
	...
	if response.IsError() {
		if response.StatusCode() == http.StatusUnauthorized {
			return s.RemoveAllowedMacAddressV1(
				macAddress)
		}
