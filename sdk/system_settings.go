...
type ResponseSystemSettingsGetAuthenticationAndPolicyServersResponse struct {
	...
	UseDnacCertForPxgrid *bool                                                                          `json:"useDnacCertForPxgrid,omitempty"` // Use CATALYST Certificate For Pxgrid
...
type ResponseSystemSettingsGetAuthenticationAndPolicyServersResponseCiscoIseDtos struct {
	...
	TrustState                 string                                                                                                 `json:"trustState,omitempty"`                 // Trust State between CATALYST and the ISE server
	InstanceUUID               string                                                                                                 `json:"instanceUuid,omitempty"`               // Internal record identifier
	...
	FailureReason              string                                                                                                 `json:"failureReason,omitempty"`              // Reason for integration failure between CATALYST and the ISE server
...
type RequestSystemSettingsAddAuthenticationAndPolicyServerAccessConfiguration struct {
	...
	UseDnacCertForPxgrid       *bool                                                                                                 `json:"useDnacCertForPxgrid,omitempty"`       // Value true to use CATALYST certificate for Pxgrid. Default value is false
